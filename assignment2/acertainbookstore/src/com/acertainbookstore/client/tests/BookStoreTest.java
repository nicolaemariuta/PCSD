...
public class BookStoreTest {
	...
	/**
	 * Tests that we cannot retrieve a negative number of toprated books
	 */
	@Test
	...
	/**
	 * Tests that if we add 2 books with buyMiss then we get 2 books with buyMiss
	 */
	@Test
