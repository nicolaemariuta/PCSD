...
import com.acertainfarm.clients.FarmClientConstants;
...
public class FarmUtility {
	...
	public static boolean isInvalidFieldID(int fieldID, int N) {
		return (fieldID < 1 || fieldID > N);
	}
	...
	public static boolean isInvalidHumidity(int humidity) {
		return (humidity < -50 || humidity > 50);
	}
	...
	public static List<?> SendAndRecv(HttpClient client,
		...
		if (exchangeState == HttpExchange.STATUS_COMPLETED) {
			try {
				FarmResponse bookStoreResponse = (FarmResponse) FarmUtility
